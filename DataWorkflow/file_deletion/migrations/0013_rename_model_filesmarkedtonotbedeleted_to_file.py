# Generated by Django 2.2.6 on 2020-01-16 18:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('file_deletion', '0012_filesmarkedtonotbedeleted_batch_file_unique_together'),
    ]

    operations = [
        migrations.CreateModel(
            name='FileMarkedToNotBeDeleted',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, help_text='User by which the entry was created', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='file_deletion_filemarkedtonotbedeleted_created_by_related', to=settings.AUTH_USER_MODEL)),
                ...
                ('modified_by', models.ForeignKey(blank=True, help_text='User by which the entry was modified', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='file_deletion_filemarkedtonotbedeleted_modified_by_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
